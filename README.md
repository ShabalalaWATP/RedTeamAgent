...
- Full Stage 1 release gates are not all implemented yet. Remaining gaps include model catalogue/profile management, full SSE streaming semantics, visual-regression baselines, complete WCAG audit coverage and full Docker runtime verification.
