...
- Full Stage 1 release gates are not all implemented yet. Remaining gaps include live model catalogue sync, richer capability probes, full SSE streaming semantics, visual-regression baselines, complete WCAG audit coverage and full Docker runtime verification.
