/*
 * Vendored from ReactBits (https://reactbits.dev/backgrounds/evil-eye), MIT.
 * Local change: graceful degradation guard (reduced-motion / no-WebGL) so it
 * never runs the GPU loop when unsupported or unwanted. WebGL-only; excluded
 * from unit coverage (cannot run under jsdom).
 */
